...
<div class="idea-div-l">
    ...
    <p class="p p-idea-photo">
        <iframe class="idea-photo" width="100%" height="600" style="max-width: 340px" src="https://www.youtube.com/embed/nglIto0sH4A?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </p>
</div>
