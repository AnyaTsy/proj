...
<div>
    ...
    <div v-if="currentTab == 'retouch'">
        <div>
            ...
            <p>
                Promo - this is a photo / video presentation that is translated to instagram stories in order to promote a personal brand and increase sales of products and services.
                <br>
                <b>Format</b> - 9:16 <br>
                <b>Duration</b> - from 15 to 30 seconds <br>
            </p>
            <div>
                <div class="row">
                    <div class="col-md-4">
            ...
            <h3> What types are exists </h3>
            <p>
                <b>Photo</b> <br>
                <b>Video</b> <br>

                <b>For ads with bloggers</b> <br>
                <b>For ads via Facebook / Instagram</b> <br>

                <b>For personal accounts</b> <br>
                <b>For commercial accounts</b> <br>
            </p>
        </div>
        <div>
            <h3> What is the difference between personal and commercial </h3>
            <p>
                Advertising is based on these factors:
            </p>
            <div class="row">
                <div class="col-md-6">
                    <h4>Personal Accounts</h4>
                    <b>Personal Brand</b> - promote yourself
                    <b>Benefits for subscribers</b> - promote yourself as an expert
                    <b>Trends</b> - catch a popular topic
                </div>
                <div class="col-md-6">
                    <h4>Product Uniqueness</h4>
                    <b>Benefits of a product or service</b>
                    <b>Sale of products and services</b>
                </div>
            </div>
        </div>
        <div>
            <h3> Selecting a topic for video </h3>
            <p>
                1 topic = 1 layout
            </p>
            <p>
                Do not attempt to put everything in one promo.
            </p>
            <p>
                Choose the main topic you are promoting and stay up to it.
            </p>
            <p>
                For different audience, use different videos for best efficiency.
            </p>
            <p>
                   <b>Example:</b> if you are a fitness blogger and advertise your own infoproduct
                at one audience (for an example of a food blogger) - video related to food and training
                will be successful. Another audience (let it be bloggers with children)
                will like video about home workouts.
            </p>
        </div>
        <div>
            <h3> Promo creation plan  </h3>
            <p>
                1. Define our target audience and the topic we will promote.
            </p>
            <p>
                2. Write a script for the future promo.
            </p>
            <p>
                3. Choose photo and video materials.
            </p>
            <p>
                4. Edit materials, add text blocks.
            </p>
            <p>
                5. Add music and edit video (if it is a video).
            </p>
        </div>
        <div>
            <h3> Define target audience  </h3>
            <p>
                TA (target audience) - is a group of people who potentially need
        ...
        <div>
            ...
            <p>
                1. What is the gender of your potential follower / client?
            </p>
            <p>
                2. How old is he / she?
            </p>
            <p>
                3. Where does he or she lives?
            </p>
            <p>
                4. What is the marital status?
            </p>
            <p>
                5. Does he / she has children?
            </p>
            <p>
                6. What kind of education did he / she got?
            </p>
            <p>
                7. What is his / her job?
            </p>
            <p>
                8. How much does he / she make?
            </p>
            <p>
                9. What are his / her hobbies?
            </p>
            <p>
                10. How does he / she spend weekend?
            </p>
            <p>
                11. What he / she wants to gt from your blog / product?
            </p>
            <p>
                12. What are his/ her fears and desires?
            </p>
            <p>
                The more detailed you describe the portrait of your subscriber, the more likely it will hit the target.
            </p>
        </div>
        <div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    Story of your success -> <br>
                    Benefits -> <br>
                    Call to action
                </div>
            </div>
            <p>
                Clickbait - a title that will definitely make a person click.
            </p>
        </div>
        <div>
            <h3>Benefit</h3>
            <div class="row">
                ...
                <p>Offer something unique or something that will help close the "desires" of most people/p>
            </div>
        </div>
        <div>
            <h3>Personality</h3>
            <div class="row">
                ...
                <p>
                    Start your promo with who you are and
                    your experience, story of your success
                </p>
            </div>
        </div>
        <div>
            ...
            <div class="row">
                ...
                <p>
                    At the end, give people something for free,
...
The same as for photos
        ...
        <div>
            ...
            <p>
                <b> Number - Adjective - Noun - Keyword - Promise</b>
                <span>
                    6 simple formulas to write catchy headline in 2 minutes
                </span>
            </p>
            <p>
                <b> How to - Action - Action - Word - Promise</b>
                <span>
                    How to write a catchy headline for any post
                </span>
            </p>
            <p>
                <b> Wording - Action Guide - Keyword - Promise </b>
                <span>
    ...
    <div v-if="currentTab == 'edit-video'">
        <div>
            ...
            <div>
                ...
                an opinion leader or group authority is one of the most effective ways to promote.
            </div>
            <div>
                An influencer is considered to be someone who is able to influence
                the decisions and opinions of others due to the presence of vast experience,
                authority, or knowledge in a particular area.
                If we talk about social networks, bloggers are indisputably such people.
            </div>
            <div>
                But do not forget, that only bloggers with a similar target audience to yours will be suitable for advertising.
        ...
        <div>
            ...
            <ul>
                <li>Lead to ad <br>
                    ...
                    <br> <br>
                    Lead to ad may be in a survey format, for example: "Did you know that you can professionally edit video without having a powerful computer?
                    <br> <br>
                    Lead to ad may be native. For example: blogger is going to an event and asks subscribers what to wear - and you gave a dress for advertising.
                    <br> <br>
            ...
            <div>
                <div class="row">
                    <div class="col-md-4">
                        <p class="p p-idea-photo">
                            <img src="/app/lectures/img/ad/lead.PNG" alt="Lead" class="idea-photo">
                        </p>
                    </div>
                    <div class="col-md-4">
                        <p class="p p-idea-photo">
                    ...
                    <div class="col-md-4">
                        <p class="p p-idea-photo">
                            <img src="/app/lectures/img/ad/final.PNG" alt="Final" class="idea-photo">
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div>
            <h3>What the price depends on</h3>
            <p>
                1.<b>Number of subscribers</b> <br>
            ...
            <p>
                2. <b>Blogger's self-esteem</b> <br>
            ...
            <p>
                3. <b>Indicators of involvement</b> <br>
            ...
            <p>
                4. <b>Advertising type and its duration</b> <br>
            ...
            <p class="text-center">
                Choosing a blogger for advertising, you should be careful.
                Many offers may be unfavorable due to the count of bots in subscribers.
            </p>
            <p class="text-center">
               You can learn where to find blogger in this article: <br>
                <a href="https://tribegrowth.com/instagram-influencer-marketing-platforms/">tribegrowth.com/instagram-influencer-marketing-platforms</a>
            </p>
        </div>
        <div>
            <h3>How to negotiate cooperation</h3>
            <p>If you find an appropriate blogger - it's not a fact that you will be able to agree with him / her on cooperation.
    ...
    <div v-if="currentTab == 'edit-photos'">
        <div>
            ...
            <p>
                Here you can find a good article about how to set up your first ad campaign on Facebook: br
                <a href="https://buffer.com/library/instagram-ads-guide/#creating-instagram-ads-using-facebook-ads-manager">buffer.com/library/instagram-ads-guide</a>
            </p>
        </div>
    </div>
</div>
