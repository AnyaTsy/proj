        ...
        <div class="bg-body-light">
            <div class="content content-full">
                <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                    <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2" style="text-align: center;">FAQ</h1>
                </div>
            </div>
        </div>
        <!-- END Hero -->
        ...
        <div class="content">
            ...
            <div class="block block-rounded block-bordered">
                ...
                <div class="block-content">
                    <!-- Introduction -->
                    <h2 class="content-heading"><strong>1.</strong> Как принять участие?</h2>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                                        <div class="block-content">
                                                            <img class="img-avatar" src="/media/avatars/avatar5.jpg" alt="">
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                                        <div class="block-content">
                                                            <img class="img-avatar" src="/media/avatars/avatar11.jpg" alt="">
                                                        </div>
                                                        <div class="block-content block-content-full">
                                                ...
                                                <div class="col-lg-6">
                                                    <a class="block block-link-shadow text-center" href="javascript:void(0)">
                                                        <div class="block-content">
                                                            <img class="img-avatar" src="/media/avatars/avatar7.jpg" alt="">
                                                        </div>
                                                        <div class="block-content block-content-full">
                    ...
                    <!-- Features -->
                    <h2 class="content-heading"><strong>2.</strong> Оплата</h2>
                    <div class="row items-push">
                        <div class="col-lg-4">
                            <p class="text-muted">
                            ...
                            <div id="faq2" role="tablist" aria-multiselectable="true">
                                ...
                                <div class="block block-rounded mb-1">
                                    <div class="block-header block-header-default" role="tab" id="faq2_h2">
                                        <a class="font-w600" data-toggle="collapse" data-parent="#faq2" href="#faq2_q2" aria-expanded="true" aria-controls="faq2_q2">Что делать, если я указал(а) неправильный адрес электронной почты?</a>
                                    </div>
                                    <div id="faq2_q2" class="collapse" role="tabpanel" aria-labelledby="faq2_h2" data-parent="#faq2">
                                        <div class="block-content">
                                            <p>Если вы указали неправильный адрес электронной почты и помните его, то вы можете:</p>
                                            <ul>
                                                <li></li>
                                            </ul>
