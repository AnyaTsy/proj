                ...
                <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                    ...
                    <!-- Header -->
                        <div class="mb-2 text-center">
                            ...
                            <p class="text-uppercase font-w700 font-size-sm text-muted">Регистрация</p>
                        </div>
                        <!-- END Header -->
                        ...
                        <!-- Sign Up Form -->
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" placeholder="Имя Пользователя" autofocus>
                            ...
                            <div class="form-group text-center">
                                <div class="custom-control custom-checkbox custom-control-primary">
                                    ...
                                    <label style="font-weight: 400;" class="custom-control-label" for="signup-terms">Нажимая кнопку Регистрация, вы принимаете <a class="font-w600 font-size-sm" target="_blank"  href="/terms">Условия, Политику использования данных</a></label>
                                </div>
                            </div>
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-hero-success">
                                    <i class="fa fa-fw fa-plus mr-1"></i> Регистрация
                                </button>
                            </div>
                        </form>
                        <!-- END Sign Up Form -->
