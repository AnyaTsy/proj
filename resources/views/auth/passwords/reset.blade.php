                ...
                <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                    ...
                    <!-- Header -->
                        <div class="mb-2 text-center">
                            ...
                            <p class="text-uppercase font-w700 font-size-sm text-muted">Восстановление пароля</p>
                        </div>
                        <!-- END Header -->
                        ...
                        <form class="js-validation-reminder"  method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="Электронная Почта">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="Новый Пароль">
                                    <div class="input-group-append">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-hero-warning">
                                    <i class="fa fa-fw fa-reply mr-1"></i> Сбросить Пароль
                                </button>
                            </div>
                        </form>
                        <!-- END Reminder Form -->
