...
!function (e) {
    ...
    32: function (e, n, r) {
        ...
        var t = function () {
            ...
            var n, t, o;
            return n = e, o = [{
                key: "barsRandomize", value: function () {
                    jQuery(".js-bar-randomize").on("click", function (e) {
                        console.log('changed progress');
                        jQuery(e.currentTarget).parents(".progress").find(".progress-bar").each(function (e, n) {
                            var r = jQuery(n), t = parseFloat(document.getElementById('progress-bar-value').value);
